...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.CustomViewHolder> implements Serializable {

    private ArrayList<DayData> arrayList;
    public MainAdapter(ArrayList<DayData> arrayList) {
    ...
    public DayData getArrayAt(int position){
